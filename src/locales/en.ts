export default {
  ...
  "label": {
    ...
    "path": "Path",
    "redisUrl": "Redis URL",
    "redisPoolMaxSize": "Redis Pool Max Connections",
    "redisPoolWaitTimeoutMs": "Redis Pool Wait Timeout (ms)",
    "redisPoolCreateTimeoutMs": "Redis Pool Create Timeout (ms)",
    "redisPoolRecycleTimeoutMs": "Redis Pool Recycle Timeout (ms)",
    "logLevel": "Log Level",
    "lang": "Language",
